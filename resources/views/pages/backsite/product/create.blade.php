                            ...
                            <div class="card">
                                <div class="card-header bg-success text-white">
                                    <a data-action="collapse">
                                        <h4 class="card-title text-white">Tambahkan Data</h4>
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.product.store') }}"
                                            ...
                                            <div class="form-body">
                                                <div class="form-section">
                                                    <p>Tolong lengkapi dan input yang berlabel <code>required</code>,
                                                        sebelum anda klik tombol submit.</p>
                                                </div>


                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="nama">Nama Produk <code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="nama" name="nama"
                                                            class="form-control" placeholder="Contoh Surabi Kunti"
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="tipe">Tipe Produk <code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="tipe" name="tipe"
                                                            class="form-control" placeholder="Makanan Kering" value=""
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="harga" name="harga"
                                                            class="form-control"
                                                            placeholder="contoh harga 10000 tanpa titik ataupun koma"
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="qty">Stok Produk <code
                                                            style="color:red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="qty" name="qty"
                                                            class="form-control" placeholder="stok produk"
                                                            value="{{ old('qty') }}" autocomplete="off" required>
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('admin_access')
                                                                                <a class="dropdown-item"
                                                                                    href="{{ route('backsite.product.edit', $product_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan
                                                                            ...
                                                                            @can('admin_access')
                                                                                <form
                                                                                    action="{{ route('backsite.product.destroy', $product_item->id) }}"
                                                                                    method="POST"
